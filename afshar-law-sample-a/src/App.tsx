        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {[
              ...
              { 
                title: lang === 'en' ? "Business / Commercial Transactions" : "Transacciones Comerciales", 
              ...
              { 
                ...
                desc: lang === 'en' ? "Fighting aggressively for maximum compensation for injury victims and grieving families." : "Luchando agresivamente por la máxima compensación para víctimas y familias.",
                img: "https://images.unsplash.com/photo-1588681664899-f142ff2dc9b1?auto=format&fit=crop&q=80" 
              },
              { 
                title: lang === 'en' ? "International Law Attorney" : "Abogado de Derecho Internacional", 
              ...
              <Reveal key={i} delay={i * 0.1}>
                <div className="group border border-[#1E3655] min-h-[360px] py-8 flex flex-col justify-center items-center hover:border-[#E4B651] transition-all duration-300 relative cursor-pointer overflow-hidden text-center px-6 bg-[#0A1A2F]">
                  <div className="absolute inset-0 z-0 bg-[#040A14]">
                    <img src={area.img} alt={area.title.replace('\n', ' ')} className="w-full h-full object-cover group-hover:scale-110 transition duration-700 opacity-35 group-hover:opacity-50" />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#040A14]/95 via-[#040A14]/80 to-[#040A14]/40"></div>
                  </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-[14px] text-[#A0AABF]">
                {[
                  { label: lang === 'en' ? "Construction Law Attorney" : "Abogado de Construcción" },
                  { label: lang === 'en' ? "Business / Commercial Transactions" : "Transacciones Comerciales" },
                  { label: lang === 'en' ? "Personal Injury & Wrongful Death" : "Lesiones Personales y Muerte Injusta" },
                  { label: lang === 'en' ? "International Law Attorney" : "Abogado de Derecho Internacional" },
                ].map(link => (
